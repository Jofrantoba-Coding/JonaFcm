 ...
 */
package com.jofrantoba.fcm.xmpp.debug;
 ...
 */
@Log4j2
public class TestXmppFcmNotification {
    
    public static void main(String arg[]) throws NoSuchAlgorithmException, KeyManagementException{
        try{
        int contador = 0;
            //while (true) {
                contador = contador + 1;
